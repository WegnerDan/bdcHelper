...
* ---------------------------------------------------------------------
    ...
    lo_bdc->add_field( iv_name  = 'IKPF-WERKS'   iv_value = 'Werk' ).
    lo_bdc->add_field( iv_name  = 'IKPF-LGORT'   iv_value = 'Lagerort' ).
...
* ---------------------------------------------------------------------
    ...
    lo_bdc->add_field( iv_name  = 'ISEG-MATNR(01)'  iv_value = 'Material' ).
